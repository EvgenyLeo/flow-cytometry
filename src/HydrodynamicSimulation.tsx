...
export default function HydrodynamicSimulation() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Background
      'radial-gradient(circle at center, #071427 0%, #030712 55%, #02050d 100%)'

      // Sheath fluid background gradient
      const sheathGrad = ctx.createLinearGradient(chamberX, 0, chamberX + CHAMBER_W, 0)
      sheathGrad.addColorStop(0, "rgba(2, 12, 35, 0.42)")
      sheathGrad.addColorStop(0.25, "rgba(3, 26, 68, 0.28)")
      sheathGrad.addColorStop(0.5, "rgba(5, 38, 100, 0.18)")
      sheathGrad.addColorStop(0.75, "rgba(3, 26, 68, 0.28)")
      sheathGrad.addColorStop(1, "rgba(2, 12, 35, 0.42)")
        ...
        <div style={{
          ...
          <div style={{ position: "relative", height: 380, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{
              ...
              boxShadow: "0 0 18px rgba(34,211,238,0.28), 0 0 40px rgba(34,211,238,0.18), 0 0 80px rgba(34,211,238,0.10)",
            }} />
            <input
              type="range"
              min={0}
